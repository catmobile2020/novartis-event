            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <a href="{{route('admin.days.create')}}" class="btn btn-primary" style="float: right;">Add Day</a>
                    </div>
                                        ...
                                        <td class="size-80">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{route('admin.days.edit',$row->id)}}">Edit</a></li>
                                                    <li><a href="{{route('admin.days.destroy',$row->id)}}">Delete</a></li>
                                                    <li><a href="{{route('admin.sessions.index',$row->id)}}">Sessions</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
